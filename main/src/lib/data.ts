...
export const dummyBooks: Book[] = [
  {
    ...
    price: 29.99,
    imageUrl: "https://placehold.co/400x600/2e3192/ffffff?text=Quantum+Physics",
    category: "Science",
    isFeatured: true,
  ...
  },
  {
    ...
    author: "Leo Chen",
    price: 45.50,
    imageUrl: "https://placehold.co/400x600/3871c1/ffffff?text=The+Art+of+Python",
    category: "Technology",
    isFeatured: true,
  ...
  },
  {
    ...
    price: 35.00,
    imageUrl: "https://placehold.co/400x600/00aaeb/2b2b2b?text=Ancient+History",
    category: "History",
    isFeatured: true,
  ...
  },
  {
    ...
    author: "Maria Garcia",
    price: 52.00,
    imageUrl: "https://placehold.co/400x600/2b2b2b/ffffff?text=Economics",
    category: "Business",
    isFeatured: true,
    ...
    price: 65.00,
    imageUrl: "https://placehold.co/400x600/2e3192/ffffff?text=Calculus",
  ...
  },
  {
    ...
    price: 28.75,
    imageUrl: "https://placehold.co/400x600/3871c1/ffffff?text=Modernist+Lit",
    category: "Literature",
    isFeatured: false,
