...
export function BookCard({ book }: BookCardProps) {
  ...
  return (
    ...
    >
      <div
        className="p-px bg-gradient-to-br from-white/10 to-transparent rounded-xl h-full group transition-all duration-300 hover:from-primary/50 hover:to-secondary/50 preserve-3d"
      >
        <Card
        ...
        >
          ...
          <CardContent className="flex-grow p-5 flex flex-col relative z-0 bg-card">
            <p className="text-xs font-semibold uppercase tracking-wider text-primary mb-1 font-sans">
              {book.category}
            </p>
            <CardTitle className="text-lg font-bold leading-snug mb-2 text-foreground/90 flex-grow">
              {book.title}
            </CardTitle>
